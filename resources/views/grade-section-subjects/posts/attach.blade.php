		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	            	{!! Form::open(['url' => '/posts/' . $post->id . '/attach']) !!}
					...
					<div class="form-group pull-right">
						<div class="col-md-6 col-md-offset-4">
							<button type="button" class="btn btn-danger" onclick="location.href='/posts'">
								Back
							</button>
						</div>
					</div>
...
<script type="text/javascript">
	function attachMore(){
		...
		cell1.innerHTML = 	'Grade section subject<br>' +

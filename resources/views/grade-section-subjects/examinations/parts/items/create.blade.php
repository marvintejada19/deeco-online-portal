		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
				...
				<div class="panel-body">
					@include('grade-section-subjects.examinations.parts.items.search')

					{!! Form::model($item = new \App\Models\Examinations\ExaminationPartItem, ['url' => '/examinations/' . $examination->id . '/parts/' . $part->id . '/items']) !!}
						@include('grade-section-subjects.examinations.parts.items.form', ['submitButtonText' => 'Add item'])
					{!! Form::close() !!}
				</div>
			</div>
		</div>

		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	            	{!! Form::open(['url' => '/examinations/' . $examination->id . '/attach']) !!}
					...
					<table class="table" id="additional_attachments">
						...
						<tr>
						    <td>{!! Form::input('datetime-local', 'exam_start[]', $timeNow, ['class' => 'form-control', 'required']) !!}</td>
						    <td>{!! Form::input('datetime-local', 'exam_end[]', $timeEnd, ['class' => 'form-control', 'required']) !!}</td>
						</tr>
					...
					<div class="form-group pull-right">
						<div class="col-md-6 col-md-offset-4">
							{!! Form::submit('Attach examination', ['class' => 'btn btn-primary form-control']) !!}
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	function attachMore(){
		...
		cell1.innerHTML = 	'<hr/>' +
							...
							'<input type="datetime-local" name="exam_start[]" class="form-control" value="{{ $timeNow }}" required></input>';
		...
		cell2.innerHTML = 	'<hr/>' +
							...
							'<input type="datetime-local" name="exam_end[]" class="form-control" value="{{ $timeEnd }}" required></input>';
	}
</script>
@endsection
...
<div class="panel panel-success">
    <div class="panel-heading">
        ...
        <button type="button" class="btn btn-success pull-right" onclick="location.href='/classes/{{ $gradeSectionSubject->id }}/requirements/{{ $subjectRequirement->id }}/submission'">

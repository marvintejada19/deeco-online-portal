		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
				...
				<div class="panel-body">
					{!! Form::open(['url' => '/examinations/' . $examination->id . '/parts/' . $part->id . '/items/' . $item->id . '/delete']) !!}
						<div class="form-group">
							...
							<input class="btn btn-primary" type="button" onclick="location.href='/examinations/{{ $examination->id}}/parts/{{ $part->id }}'" value="Back">
    					</div>
					{!! Form::close() !!}
				</div>
			</div>

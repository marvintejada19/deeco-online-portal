<table class="table">
	{!! Form::open(['url' => '/examinations/' . $examination->id . '/parts/' . $part->id . '/items/create']) !!}	
	<tr>
		<th>Category</th>
		<th>Topic</th>
	...
	<tr>
		...
		<td>
    		...
    		@else
    		<label onclick='location.href="/examinations/{{ $examination->id }}/parts/{{ $part->id }}/items/create"' class="btn btn-warning form-control">

		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
				...
				<div class="panel-body">
					{!! Form::open(['url' => 'requirements/' . $requirement->id . '/attach/' . $attachment->id . '/delete/']) !!}
						...
						<input class="btn btn-primary" type="button" onclick="location.href='/requirements/{{ $requirement->id }}'" value="Back">
					{!! Form::close() !!}
				</div>
			</div>
		</div>

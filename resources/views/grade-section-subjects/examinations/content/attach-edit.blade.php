		...
		<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	            	{!! Form::open(['url' => '/examinations/' . $examination->id . '/attach/' . $attachment->id]) !!}
					<table class="table">
						<tr>
						...
						<tr>
						    <td>{!! Form::input('datetime-local', 'exam_start', $attachment->exam_start, ['class' => 'form-control', 'required']) !!}</td>
						    <td>{!! Form::input('datetime-local', 'exam_end', $attachment->exam_end, ['class' => 'form-control', 'required']) !!}</td>
						</tr>
					</table>

					<div class="form-group pull-right">
						<div class="col-md-6 col-md-offset-4">
							<button type="button" class="btn btn-danger" onclick="location.href='/examinations/{{ $examination->id }}'">
								Back
							</button>
						</div>
					</div>
